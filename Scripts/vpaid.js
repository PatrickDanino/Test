var VpaidVideoPlayer = function() {
    ...
    var adChoicesAE = {};
    adChoicesAE.domain = 'www.amazon.ae';
    adChoicesAE.iconSprite = 'https://images-na.ssl-images-amazon.com/images/G/03/cstone/adchoices/topright/default_opa.png';
    adChoicesAE.spriteWidth = 91;
    ...
    var adChoicesAU= {};
    adChoicesAU.domain = 'www.amazon.com.au';
    adChoicesAU.iconSprite = 'https://images-fe.ssl-images-amazon.com/images/G/03/cstone/adchoices/topright/default_opa.png';
    adChoicesAU.spriteWidth = 91;

    var adChoicesBR= {};
    adChoicesBR.domain = 'www.amazon.com.br';
    adChoicesBR.iconSprite = 'https://images-na.ssl-images-amazon.com/images/G/03/cstone/adchoices/topright/brazil_opa.png';
    adChoicesBR.spriteWidth = 91;

    var adChoicesNL= {};
    adChoicesNL.domain = 'www.amazon.nl';
    adChoicesNL.iconSprite = 'https://images-na.ssl-images-amazon.com/images/G/03/cstone/adchoices/topright/netherlands_opa.png';
    adChoicesNL.spriteWidth = 91;

    var adChoicesSG= {};
    adChoicesSG.domain = 'www.amazon.sg';
    adChoicesSG.iconSprite = 'https://images-na.ssl-images-amazon.com/images/G/03/cstone/adchoices/topright/singapore_opa.png';
    adChoicesSG.spriteWidth = 91;
...
VpaidVideoPlayer.prototype.timeUpdateHandler_ = function() {
    ...
    if (this.videoSlot_.currentTime > 1) {
...
VpaidVideoPlayer.prototype.updateVideoSlot_ = function() {
    ...
    this.clickToPlay_ = document.createElement('div');
    this.clickToPlay_.setAttribute('style', "width: 100%; height: 100%; cursor: pointer; display: none;");
    this.slot_.appendChild(this.clickToPlay_);
    var player = this;
    this.clickToPlay_.addEventListener('click', function (e) {
         player.resumeAd();
         if (!e) var e = window.event;
         e.cancelBubble = true;
         if (e.stopPropagation) e.stopPropagation();
...
VpaidVideoPlayer.prototype.pauseAd = function() {
    this.log('pauseAd');
    if (this.clickToPlay_) {
        this.clickToPlay_.style.display = 'block';
    }
...
VpaidVideoPlayer.prototype.resumeAd = function() {
    this.log('resumeAd');
    if (this.clickToPlay_) {
        this.clickToPlay_.style.display = 'none';
    }
    this.videoSlot_.play();
...
VpaidVideoPlayer.prototype.getAdRemainingTime = function() {
    var duration = this.attributes_['remainingTime'];
    var remainingTime = duration;
    if (this.videoSlot_ && this.videoSlot_.currentTime) {
        remainingTime = duration - this.videoSlot_.currentTime;
    }
